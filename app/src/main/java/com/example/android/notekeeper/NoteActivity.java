...
public class NoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        List<CouraseInfo> courses = DataManager.getInstance().getCourses();
        ArrayAdapter<CouraseInfo> adapterCourses =
    ...
    private void storePreviousNoteValues() {
        CouraseInfo course = DataManager.getInstance().getCourse(mOriginalNoteCourseId);
    ...
    private void saveNote() {
        mNote.setCourse((CouraseInfo) mSpinnerCourses.getSelectedItem());
    ...
    private void sendEmail() {
        CouraseInfo course = (CouraseInfo) mSpinnerCourses.getSelectedItem();
